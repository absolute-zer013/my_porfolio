...
export const employmentHistory: EmploymentEntry[] = [
  {
    ...
    accentColor: '#c8a882',
    points: [
      'Develop and maintain production Flutter mobile applications for Sarawak state government — including SANSOLS (NRE & immigration system) and SAFHIS (medical facility registration).',
      'Built the State Secretary Android tablet app for reviewing and approving foreign worker permit applications, with digital signing integration via POS Digicert.',
      'Set up GitHub Actions CI/CD pipelines for automated APK builds and Play Store deployment across DEV, ALPHA, and LIVE environments.',
      'Implemented GraphQL API clients, PDF document generation (AP certificates, hiring reports), and role-based permission systems.',
      'Resolved 50+ critical production bugs across government-facing and employer-facing app flows.',
      'Contributed to freelance web projects using React, Vite, Tailwind CSS, and Firebase Hosting.',
    ],
  },
  {
    company: 'Telekom Malaysia (TM ELIT)',
    role: 'Human Resource & Competency Training Executive',
    period: 'Oct 2021 – May 2022',
    type: 'Full-time',
    accentColor: '#8ba5b8',
    points: [
      'Organised and coordinated employee training programmes to upskill staff during the Covid-19 transition to remote work.',
      'Trained colleagues on advanced Excel functions (XLookup, PivotTable, complex formulas) to improve productivity.',
      'Introduced Power BI and Canva as daily presentation and reporting tools.',
    ],
  },
  {
    company: 'Self-employed',
    role: 'Freelance Photographer, Videographer & Graphic Designer',
    period: 'June 2018 – June 2021',
    type: 'Freelance',
    accentColor: '#9baa8c',
    points: [
      'Official event photographer for 50+ club events and private functions across Malaysia.',
      "Comic Fiesta 2019, 2022 & 2024 — Official Photographer at Malaysia's largest comic and pop culture convention.",
      'Hired as wedding photographer and graphic designer for private clients.',
      'Malaysian ICT Volunteer 2018 — Photoshop tutor for programme participants.',
    ],
  },
  {
    ...
    accentColor: '#b89ab8',
    points: [
      'Assisted the development team with software development tasks and gained hands-on exposure to professional software workflows.',
    ],
  },
];
